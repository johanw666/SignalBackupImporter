...
public class AttachmentSecretProvider {
  ...
  public synchronized AttachmentSecret getOrCreateAttachmentSecret() {
    ...
    String unencryptedSecret = TextSecurePreferencesPartial.getAttachmentUnencryptedSecret(context);
    String encryptedSecret   = TextSecurePreferencesPartial.getAttachmentEncryptedSecret(context);
  ...
  private AttachmentSecret getUnencryptedAttachmentSecret(@NonNull Context context, @NonNull String unencryptedSecret)
  {
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
      ...
      TextSecurePreferencesPartial.setAttachmentUnencryptedSecret(context, null);
